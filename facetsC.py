...
class Facets():
    ...
    def decompose_Space(self):
        ...
        for i in range(self.__numberOfFacets):
            ...
            self.__features_for_each_facet1.append(temp_f[:30])#Facet extension Y 
            ...
            #we found this following steps to be unnessery so in the papar we only use the top 500 remainder_features in the clustering
            if (i)!=9:
